...
const S08_PRESETS: S08Preset[] = [
  {
    label: 'UTP: bienvenido',
    name: 'Ejercicio Clase UTP ("bienvenido a la UTP")',
    badge: 'Prof. Olivares',
    key: 'MIEDO',
    text: 'bienvenido a la UTP',
    description: 'Ejercicio de clase resuelto por el profesor Carlos Olivares. Criptograma oficial: KB DL XM KD OM CH GQ UN.',
  },
  {
    label: 'UTP: bienvenidos',
    name: 'Variante UTP ("bienvenidos a la UTP")',
    badge: 'Prof. Olivares',
    key: 'MIEDO',
    text: 'bienvenidos a la UTP',
    description: 'Variante con "bienvenidos" en plural (la letra "s" final cambia la paridad de los dígramos).',
  },
  {
    label: 'UTP: Sombras',
    name: 'Ejercicio Clase UTP ("Las sombras...")',
    badge: 'Diapositiva 21-23',
    key: 'MIEDO',
    text: 'Las sombras llaman a la puerta del castillo hoy',
    description: 'Ejercicio completo con clave MIEDO. Demuestra ruptura de gemelas (SS, LL) y relleno final (YX).',
  },
  {
    label: 'S08: VERANO AZUL',
    name: 'Ejemplo de Matriz S08 (VERANO AZUL)',
    badge: 'Diapositivas 10-17',
    key: 'VERANO AZUL',
    text: 'EA LU DH ED FU AX OT YU MI EN',
    description: 'Matriz oficial de clase para demostrar Misma Fila, Misma Columna, Rectángulo y Letras Compartidas.',
  },
  {
    label: 'CRIPTOGRAFIA',
    ...
    description: 'Clásico universitario para probar las tres reglas geométricas.',
  },
];
          ...
          <div>
            ...
            {result.formattedOutput === 'KB DL XM KD OM CH GQ UN' && (
              <div className="mt-2 inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 text-[11px] font-mono font-bold">
                ...
                <span>Verificado: Coincide exactamente con la respuesta oficial del Prof. Olivares en clase (01:15:38).</span>
              </div>
            )}
          </div>
